...
**Note**: To install services [insight-api](https://github.com/amigochain/amigo-insight-api) and [insight-ui](https://github.com/amigochain/amigo-insight-ui) you'll need to clone the repositories locally.

...
**Note**: To install services [insight-api](https://github.com/kalilinuxoo7/simple-insight-api) and [insight-ui](https://github.com/kalilinuxoo7/simple-insight-ui) you'll need to clone the repositories locally.
